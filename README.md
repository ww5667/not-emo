...
**在线 Demo：[https://ww5667.github.io/not-emo/](https://ww5667.github.io/not-emo/)**
...
首次使用需在仓库 **Settings → Pages → Build and deployment → Source** 选择 **GitHub Actions**。部署结果以 [Actions](https://github.com/ww5667/not-emo/actions) 的成功状态为准；上方 Demo 地址在成功部署后可访问。
